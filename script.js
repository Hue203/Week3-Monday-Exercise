///2.Object Shorthand
//2.1.Refactor to use object shorthand when defining the property & value pairs which describe bird.
const name = "Parrot";
...
console.log(bird);
//2.2.Refactor the code with object shorthand when defining the property value pairs which describe bird such that a property talons is true. Use object property shorthand.
const name = "Parrot";
const colors = ["Red", "Green", "Blue", "Yellow"];
...
console.log(bird);
//2.3. Define an object vietnam using the variables capital & continent. Use shorthand.
const capital = "Hanoi";
...
console.log(vietnam);
//2.4.Define an object car using the variables wheelsCount, doorsCount, & color as property shorthand.
const wheelsCount = 4;
const doorsCount = 4;
const color = "black";
